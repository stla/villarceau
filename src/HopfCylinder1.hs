...
-- implicit equation of great circle: cot(phi) = a cos(theta-theta0)
tripletOnCircle :: GLfloat -> (Point, Point, Point)
tripletOnCircle theta =
  let phi = atan (1 / cos (theta - pi/4)) in
...
main = do
  ...
  _ <- createWindow "A Hopf cylinder"
