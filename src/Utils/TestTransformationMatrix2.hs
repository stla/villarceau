module Utils.TestTransformationMatrix2
  where
import           Data.IORef
...
display context = do
  ...
  forM_ myTriplets $ \triplet ->
    renderPrimitive Triangles $ do
      materialDiffuse FrontAndBack $= red
      mapM_ (\(x, y, z) -> vertex $ Vertex3 x y z) [fst3 triplet, snd3 triplet, thd3 triplet]
  swapBuffers
