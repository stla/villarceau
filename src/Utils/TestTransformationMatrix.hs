module Utils.TestTransformationMatrix
  where
import           Data.IORef
...
myTriplet :: (Point, Point, Point)
myTriplet = ((-1,5,1),(2,1,8),(-5,0,3)) -- issue if in plane z=0 (or plane z=d ?)
...
display context = do
  ...
  renderPrimitive Triangles $ do
    ...
    mapM_ (\(x, y, z) -> vertex $ Vertex3 x y z) [fst3 myTriplet, snd3 myTriplet, thd3 myTriplet]
  swapBuffers
